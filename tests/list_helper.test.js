...
describe('favorite blog', () => {
  ...
  test('of a bigger list is returns right', () => {
    const expected = {
      title: 'Canonical string reduction',
      author: 'Edsger W. Dijkstra',
      likes: 12
    ...
    expect(listHelper.favoriteBlog(bigBlogList)).toEqual(expected)
  })
})
...
describe('most blogs', () => {
  ...
  test('of a bigger list is returns right', () => {
    ...
    expect(listHelper.mostBlogs(bigBlogList)).toEqual(expected)
  })
})
...
describe('most likes', () => {
  ...
  test('of a bigger list is returns right', () => {
    ...
    expect(listHelper.mostLikes(bigBlogList)).toEqual(expected)
  })
})